...
class cdsSDK {
    constructor(options = {}) {
      this.options = {
        ...
        scriptUrl: `https://cdn.jsdelivr.net/gh/hydracds/swap-sdk@v${options.version || '1.0.5'}/widget.js`,
        styleUrl: `https://cdn.jsdelivr.net/gh/hydracds/swap-sdk@v${options.version || '1.0.5'}/styles.css`,
        version: 'latest',
        ...options
      };
      this.loaded = false;
