...
class cdsSDK {
    constructor(options = {}) {
      this.options = {
        ...
        scriptUrl: `https://cdn.jsdelivr.net/gh/hydracds/swap-sdk@v${options.version || '0.0.7'}/widget.js`,
        styleUrl: `https://cdn.jsdelivr.net/gh/hydracds/swap-sdk@v${options.version || '0.0.7'}/styles.css`,
        version: 'latest',
        ...options
      };
      this.loaded = false;
